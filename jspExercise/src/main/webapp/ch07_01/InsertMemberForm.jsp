...
<body onload="javascript:document.insertMemberFormA.cId.focus();">
	...
	<form name="insertMemberFormA" action="<c:url value='member.do' />"
		method="POST">
		<table border="1">
			<thead>
			...
			<tbody>
				...
				<tr bgcolor='blue'>
					...
					<input type="button" value="刪除" onclick="javascript:location.href='/jspExercise/ch07_01/deleteForm.jsp'">
					<input type="button" value="查詢" onclick="javascript:location.href='/jspExercise/ch07_01/SearchForm.jsp'">
					</td>
				</tr>
				<tr bgcolor='blue'>
					<td height="50" colspan="2" align="center"><input
						type="button" value="全部查詢"
						onclick="javascript:location.href='/jspExercise/ch07_01/ShowMember.jsp'"></td>
				</tr>
			</tbody>
		</table>
